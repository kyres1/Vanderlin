...
GLOBAL_LIST_INIT(serf_positions, list(
	...
	/datum/job/yeoman/handmason::title,
	/datum/job/yeoman/tinker::title,
	/datum/job/yeoman/weaver::title,
	/datum/job/yeoman/homesteader::title,
	/datum/job/yeoman/woodsman::title,
