...
/datum/controller/subsystem/gamemode/Initialize(time, zlevel)
	...
	for(var/datum/round_event_control/event_type as anything in typesof(/datum/round_event_control))
		...
		god_dreams = list(
			...
			"Angros" = list(
				"... the very world roared 'invictus,' harkening to something roiling and agonizing at its center forevermore... ",
				"... in absence of all sensing means, your mind draws to the Worldflame, far brighter in your dreams than any conceivable reality...",
			...
			"Akan" = list(
				"... a land of clouds pulling away from you, sinking into a sky where you'd always hoped to go...",
